...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./user/user_signup.php">Signup</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" action="search_medicine.php" method="get">
        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="search_data">
        <!-- <button class="btn btn-outline-light" type="submit">Search</button> -->
        <input type="submit" value="Search" class="btn btn-outline-light" name="search_data_medicine">
      </form>
    </div>
  </div>
</nav>
...
//   $medicine_image1=$row['medicine_image1'];
//   $medicine_price=$row['medicine_price'];
//   $category_id=$row['category_id'];
//   $brand_id=$row['brand_id'];
//   echo "<div class='col-md-4 mb-2'>
//   <div class='card'>
//               <img class='card-img-top' src='./admin_area/medicine_img/$medicine_image1' alt='$medicine_name'>
//               <div class='card-body'>
